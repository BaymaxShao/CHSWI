...
class Config:
    ...
    # cloth_types = ('uppercloth', 'coat', 'pants', 'skirts')
    ...
    output_dir = osp.join(root_dir, type)
    # model_dir = osp.join(output_dir, 'model_dump_adapter_segadpt_final')
    model_dir = osp.join(output_dir, 'test_epochs')
    # output_dir1 = osp.join(root_dir, 'res')
    # model_dir1 = osp.join(output_dir1, 'model_dump')
    # output_dir2 = osp.join(root_dir, type)
    # model_dir2 = osp.join(output_dir2, 'model_dump')
